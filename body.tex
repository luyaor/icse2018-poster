...
%
The same as INFOX did, Fork Insight analyzes each active forks of a repository and takes the diff between the fork point and the latest commits \todo{need to check}  of the fork and extracting keywords from code changes, comments and commit messages.
%
...
\vspace{-12pt}
\end{figure}
\Shurui{Forks Insight also support searching forks by keywords. For example....}
